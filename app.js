...
// ---------вычисляется вспомогательная величина---------------------------
    ...
    if (d===0){
        ...
        document.querySelector('.decision').innerHTML='B: '+b.toFixed(2)+' L:'+l.toFixed(2)
    }else if(d>0){
        // если д больше нуля
        ...
        console.log('its lalalalal'+lAlpha)
            ...
            if (Number(z.value)===0){
                ...
                h=d-alpha
                // event.target.classList.add('decision')
                document.querySelector('.l').innerHTML='L: '+l.toFixed(4)+'<br>'
                document.querySelector('.b').innerHTML='B: '+b.toFixed(4)
